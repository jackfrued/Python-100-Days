...
def generate_code(code_len=4):
    """
    生成指定长度的验证码
    :param code_len: 验证码的长度默认四个字符
    :return: 由大小写英文字母和数字构成的随机验证码
    """

    """
    不是每次验证码都是大小写英文字母和数字构成
    """
    # list_a_z = [i for i in string.ascii_uppercase + string.ascii_lowercase]
    # list_0_9 = [str(i) for i in range(10)]
    # sample_list = list_a_z + list_0_9
    # sj_code = ''.join(random.sample(sample_list, code_len)).replace(" ", "")
    # print(sj_code)
...
def main():
    while True:
        code = generate_code(need_code_len)
