...
> 作者：骆昊
>
> 说明：最近有很多想学习Python的小伙伴申请单独加我微信，因为我自己平时也很忙，没办法一一解答大家的问题，我创建了一个叫**Python100天学习交流群**，群号**680701107**，二维码在下方。群里面有我优秀的同事和朋友，我们在有时间的时候会主动为大家解答各种问题，从Python语言入门到Web应用开发，从数据分析到机器学习，每个领域都有该领域的大拿为大家解惑答疑，小伙伴们可以加群进行交流。感谢**千锋教育Python教学部**对本群的支持和赞助。
